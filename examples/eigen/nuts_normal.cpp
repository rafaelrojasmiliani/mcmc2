...
// -I$EIGEN_INCLUDE_PATH -I./../../include/ nuts_normal.cpp -o nuts_normal.out
// -L./../.. -lmcmc
...
int main() {
  ...
  std::cout << "acceptance rate: "
            << static_cast<double>(settings.nuts_settings.n_accept_draws) /
                   settings.nuts_settings.n_keep_draws
            << std::endl;
